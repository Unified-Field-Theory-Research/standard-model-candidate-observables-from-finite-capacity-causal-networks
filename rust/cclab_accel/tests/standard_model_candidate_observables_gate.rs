use cclab_accel::{
    paper8_skeleton_marker, Paper8SkeletonCertificate, Paper8UpstreamBinding, PAPER1_FROZEN_COMMIT,
    PAPER2_FROZEN_COMMIT, PAPER3_FROZEN_COMMIT, PAPER4_FROZEN_COMMIT, PAPER5_FROZEN_COMMIT,
    PAPER6_FROZEN_COMMIT, PAPER7_FINAL_CERTIFICATE, PAPER7_FROZEN_COMMIT,
};
use std::fs;
...
#[test]
fn docs_keep_smc002_active_and_physical_claims_false() {
    let root = project_root();
    let theorem = read(
        &root,
        "docs/standard_model_candidate_observables_theorem.md",
